...
plt.figure(figsize=(10, 6))
plt.plot(range(100), pca.explained_variance_ratio_, marker='o', label='Component-wise explained variance ratio')
plt.plot(range(100), np.cumsum(pca.explained_variance_ratio_), marker='o', label='Cumulative explained variance ratio')
